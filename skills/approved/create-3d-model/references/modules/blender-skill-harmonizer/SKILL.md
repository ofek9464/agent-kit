...
when_to_use: Multi-skill Blender orchestration, skill graph audits, resolving overlaps between create-3d-model/pro-workflow/reference-to-3d/wireframe/UV/fit/repair skills, defining source-of-truth precedence, artifact contracts, and sequential-vs-parallel execution plans.
allowed-tools: Read Bash Glob Grep execute_blender_code get_scene_info get_object_info
---
...
- **Top-level orchestrators:** `create-3d-model`, `quality-refinement-autoloop`, `mascot-logo-reconstruction`.
