...
allowed-tools: Read Bash execute_blender_code get_scene_info get_object_info
---
...
**Validation target**: the bulb should read as emissive, cast a warm pool onto a nearby surface, and leave the lamp body visible against the darker scene. Capture and inspect a local proof render for the current task.
