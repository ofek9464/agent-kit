...
Keep this mode, the current step, and remaining work in any continuity summary. Keep it active for the rest of the conversation. Leave it only when the user explicitly asks for normal mode or says they are ready to continue normally. Do not interpret an unrelated use of the word "ready" as an exit.
